...
//    gtk_main();
    ...
    file->setReadFile("/home/jason/Desktop/OS/OS_Jason_Sam/read");
    file->setWriteFile("/home/jason/Desktop/OS/OS_Jason_Sam/write");
    OS_Token_Cmd token(file->getReadFile());
    token.tokenInit();
    token.readLine();

    for(auto temp : codeStream){
        cout << temp << " ";
    }
